...
class RoutineActivity : AppCompatActivity() {
    ...
    private fun setActiveRoutine(routine: Routine) {
        ...
        activeRoutine.exerciseList = routine.exerciseList.toList()
    ...
    private fun createRecyclerView(exerciseArray: Array<Exercise>) {
        ...
        recyclerView.adapter = ExerciseCustomAdapter(exerciseArray)
    }
